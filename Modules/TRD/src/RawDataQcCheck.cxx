...
#include "TRD/RawDataQcCheck.h"

namespace o2::quality_control_modules::trd
{

RawDataQcCheck::~RawDataQcCheck()
{
  if (mHistogram) {
    delete mHistogram;
  }
...
void RawDataQcCheck::initialize(o2::framework::InitContext& /*ctx*/)
{
  ILOG(Info) << "initialize RawDataQcCheck" << ENDM; // QcInfoLogger is used. FairMQ logs will go to there as well.
...
void RawDataQcCheck::startOfActivity(Activity& activity)
{
  ILOG(Info) << "startOfActivity : " << activity.mId << ENDM;
  mHistogram->Reset();
}

void RawDataQcCheck::startOfCycle()
{
  ILOG(Info) << "startOfCycle" << ENDM;
}

void RawDataQcCheck::monitorData(o2::framework::ProcessingContext& ctx)
{
...
void RawDataQcCheck::endOfCycle()
{
  ILOG(Info) << "endOfCycle" << ENDM;
}

void RawDataQcCheck::endOfActivity(Activity& /*activity*/)
{
  ILOG(Info) << "endOfActivity" << ENDM;
}

void RawDataQcCheck::reset()
{
