...
///
/// \file   RawDataQcPostProccessing.h
/// \author My Name
///
...
/// \author My Name
class RawDataQcPostProccessing final : public quality_control::postprocessing::PostProcessingInterface
{
 public:
  /// \brief Constructor
  RawDataQcPostProccessing() = default;
  /// \brief Destructor
  ~RawDataQcPostProccessing() override;
